...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('create-remove-role-msg')
        .setDescription('Creates an Remove Role message')
    ...
    async run(client, interaction)
    {
        try
        {
            ...
            const embed = new MessageEmbed()
                        ...
                        .setTitle(`Remove role - ${name}`)
                        .setDescription('You can select remove any role from yourself')
                        .setColor('#FFC402')
                        .setTimestamp();
            ...
            const row = new MessageActionRow()
                        .addComponents(
                            new MessageSelectMenu()
                                .setCustomId('remove-role-select')
